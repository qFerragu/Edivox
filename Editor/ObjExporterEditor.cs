...
namespace Edivox.Editor
{
    ...
    public class ObjExporterEditor : ScriptableObject
    {
        ...
        private static string MeshToString(MeshFilter mf, Dictionary<string, ObjMaterial> materialList)
        {
            ...
            foreach (Vector3 lv in m.vertices)
            {
                ...
                string str = string.Format("v {0:0.000000} {1:0.000000} {2:0.000000}\n", -wv.x, wv.y, wv.z);
            ...
            foreach (Vector3 lv in m.normals)
            {
                ...
                //string str = string.Format("vn {0:0.0000} {1:0.0000} {2:0.0000}\n", -wv.x, wv.y, wv.z);
                string str = string.Format("vn {0:0.0000} {1:0.0000} {2:0.0000}\n", -wv.x, wv.y, wv.z);
                sb.Append(str.Replace(",", "."));
            }
            sb.Append("\n");
            ...
            {
                string str = string.Format("vt {0:0.000000} {1:0.000000}\n", v.x, v.y);
                sb.Append(str.Replace(",", "."));
            }
        ...
        public static void MeshesToFile(MeshFilter[] mf, string folder, string filename, ExportSettings settings)
        {
            Dictionary<string, ObjMaterial> materialList = PrepareFileWrite();
